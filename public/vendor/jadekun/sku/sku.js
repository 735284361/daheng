(function () {
    ...
    SKU.prototype.init = function () {
        ...
        // 统一分销利润
        _this.warp.find('.sku_edit_warp thead').on('keyup', 'input.Js_dist_price', function () {
            _this.commonDistPrice = $(this).val();
            _this.warp.find('.sku_edit_warp tbody td[data-field="dist_price"] input').val(_this.commonDistPrice);
            _this.processSku()
        });
    ...
    SKU.prototype.SKUForm = function (default_sku) {
        ...
        if (attr_names.length === 0) {
            ...
            thead_html += '<th style="width: 130px">分销提成 <input value="' + _this.commonDistPrice + '" type="text" style="width: 50px" class="Js_dist_price"></th>';
            thead_html += '</tr>';
            ...
            cartesianProductOf.forEach(function (sku_item) {
                ...
                tbody_html += '<td data-field="dist_price"><input value="' + _this.commonDistPrice + '" type="text" class="form-control"></td>';
                tbody_html += '</tr>'
            });
