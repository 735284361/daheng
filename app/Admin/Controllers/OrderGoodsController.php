...
class OrderGoodsController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->model()->groupBy(['goods_id','sku'])->orderBy('id','desc')->get(['*','']);
        ...
        $grid->header(function ($query) {// 查询出已支付状态的订单总金额
            ...
            $html = <<<html
                <span class="label label-success">总数：<span>$total</span> 元</span>
                <span class="label label-info">总退款数：<span>$total2</span> 元</span>
html;
